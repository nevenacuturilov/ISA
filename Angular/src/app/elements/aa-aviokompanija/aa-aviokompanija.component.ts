...
@Component({
  selector: 'app-aa-aviokompanija',
  templateUrl: './aa-aviokompanija.component.html',
  styleUrls: ['./aa-aviokompanija.component.scss']
})
export class AaAviokompanijaComponent implements OnInit {
